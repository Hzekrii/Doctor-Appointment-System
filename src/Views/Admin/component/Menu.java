...
import Views.Admin.model.Model_Menu;
...
public class Menu extends javax.swing.JPanel {
    ...
    private void init() {
        ...
        listMenu1.addItem(new Model_Menu("2", "Secretaries", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("3", "Doctors", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("4", "Patients", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("5", "Appointments", Model_Menu.MenuType.MENU));
        listMenu1.addItem(new Model_Menu("6", "Logout", Model_Menu.MenuType.MENU));
    ...
    private void initComponents() {
        ...
        listMenu1 = new Views.Admin.swing.ListMenu<>();
    ...
    private Views.Admin.swing.ListMenu<String> listMenu1;

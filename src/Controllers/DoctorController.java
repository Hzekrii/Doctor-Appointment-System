...
public class DoctorController {
    ...
    public static void createDoctor(String cin, String firstName, String lastName, String email, String phone, Doctor.DoctorSpecialty speciality, String registrationNum) {
        Doctor.create(cin, firstName, lastName, email, phone, speciality, registrationNum);
    }

    public static void updateDoctor(int id, String cin, String firstName, String lastName, String email, String phone, Doctor.DoctorSpecialty speciality, String registrationNum) {
